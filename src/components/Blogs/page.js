  ...
  return (
    ...
    <div className='flex flex-col px-12 max-w-[430px]'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full px-12 mb-9'>
      {
        blogList.map((blg) =>{
          return(
            <div key={blg._id} className='relative flex flex-col max-w-[350px] p-6 rounded-md shadow-xl  hover:scale-110 duration-700'>
                <Image className='rounded-sm' alt={blg.blgName} src={`/images/${blg.blgImage}`} width={300} height={250}/>
